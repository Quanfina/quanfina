...
## 🧬 Manifesto + Felsefi Temel → `notebook/_MANIFESTO.md`

Quanfina bir yazılım projesi DEĞİL — **yaşayan ortak hafıza**. Çekirdek felsefe:
**"Sağlam gidelim, bir daha bir daha uğraşmayalım"** + **vibe coding** (Sn. Ferit
kod yazmaz, kopyala-yapıştır) + **Quanfina NE DEĞİL** (ürün/müşteri/deadline/lansman YOK,
tek odak Sn. Ferit'in finansal disiplini). Manifestonun **9 Özelliği** (Giriş/Çıkış/Bakım
yönlü) + Felsefi Temel uzun hali + Manifesto Testleri #1-4 + Sürekli Yaşar → tam metin
**`notebook/_MANIFESTO.md`** (D3-01 bölmesi, 05 Tem 2026). Davranış Kurallar'da; bu katman
felsefe/kanıt.
